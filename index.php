...
<body>
    ...
    <nav class="lien">
        <ul class="categorie">
            <li><a href="#" class="highlighted" id="conteneurFeedLink"
                    onclick="displayConteneur('conteneurFeed')">Feed</a></li>
            <li><a href="#" class="unhighlighted" id="conteneurProfileLink"
        ...
        <div id="conteneurFood" class="container">
                ...
                <div class="row">
                    <div class="col-12 .col-lg-12">
                        ...
                        <div class="restaurant">
                            ...
                            <p>
                                Contactez-nous pour une livraison à domicile ou pour une commande pour emporter. Notre
                                équipe se fera un plaisir de vous servir !
            ...
            <div id="modal-paiement" class="modal">
                <div class="modal-content">
                    ...
                    <p>Insérez ici les informations de paiement, telles que les méthodes de paiement acceptées, les
                        instructions de paiement, etc.</p>
                    ...
                    <form id="formulaire-paiement">
                        ...
                        <input type="text" id="numero-carte" name="numero-carte" placeholder="1234 5678 9012 3456"
                            required>
